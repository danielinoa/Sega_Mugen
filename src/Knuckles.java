...
public class Knuckles implements Runnable {
	...
	private Image knucklesStandingRight =  Toolkit.getDefaultToolkit().getImage("resources/k_standing_right.gif");
	private Image knucklesStandingLeft =  Toolkit.getDefaultToolkit().getImage("resources/k_standing_left.gif");
	private Image knucklesRunningRight = Toolkit.getDefaultToolkit().getImage("resources/k_run_right.gif");
	private Image knucklesRunningLeft = Toolkit.getDefaultToolkit().getImage("resources/k_run_left.gif");
	private Image knucklesJumpRight = Toolkit.getDefaultToolkit().getImage("resources/k_jumpup_right.gif");
	private Image knucklesJumpLeft = Toolkit.getDefaultToolkit().getImage("resources/k_jumpup_left.gif");
	private Image knucklesPowerPunchR = Toolkit.getDefaultToolkit().getImage("resources/k_POWERpunch_right.gif");
	private Image knucklesPowerPunchL = Toolkit.getDefaultToolkit().getImage("resources/k_POWERpunch_left.gif");
	private Image knucklesPunchR = Toolkit.getDefaultToolkit().getImage("resources/k_punch_right.gif");
	private Image knucklesPunchL = Toolkit.getDefaultToolkit().getImage("resources/k_punch_left.gif");
	private Image knucklesHurtLeft = Toolkit.getDefaultToolkit().getImage("resources/k_hurt_left.gif");
	private Image knucklesHurtRight = Toolkit.getDefaultToolkit().getImage("resources/k_hurt_right.gif");
	private Image knucklesIcon = Toolkit.getDefaultToolkit().getImage("resources/knucklesIcon.png");

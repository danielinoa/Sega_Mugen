...
public class Sonic implements Runnable{
	...
	private Image sonic;
	private Image sonicStandingRight =  Toolkit.getDefaultToolkit().getImage("resources/standing_right.gif");
	private Image sonicStandingLeft =  Toolkit.getDefaultToolkit().getImage("resources/standing_left.gif");
	private Image sonicRunningRight = Toolkit.getDefaultToolkit().getImage("resources/run_right.gif");
	private Image sonicRunningLeft = Toolkit.getDefaultToolkit().getImage("resources/run_left.gif");
	private Image sonicJumpRight = Toolkit.getDefaultToolkit().getImage("resources/jumpUp_right.gif");
	private Image sonicJumpLeft = Toolkit.getDefaultToolkit().getImage("resources/jumpUp_left.png");
	private Image sonicPowerKickR = Toolkit.getDefaultToolkit().getImage("resources/powerKick_right.gif");
	private Image sonicPowerKickL = Toolkit.getDefaultToolkit().getImage("resources/powerKick_left.gif");
	private Image sonicKickR = Toolkit.getDefaultToolkit().getImage("resources/s_kick_right.gif");
	private Image sonicKickL = Toolkit.getDefaultToolkit().getImage("resources/05.png");
	private Image sonicHurtLeft = Toolkit.getDefaultToolkit().getImage("resources/sonicHurtLeft.gif");
	private Image sonicHurtRight = Toolkit.getDefaultToolkit().getImage("resources/sonicHurtRight.gif");
	private Image sonicIcon = Toolkit.getDefaultToolkit().getImage("resources/sonicIcon.png");

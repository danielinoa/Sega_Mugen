...
public class Menu implements MouseListener, MouseMotionListener{
	...
	private Image background = Toolkit.getDefaultToolkit().getImage("menuBackground.jpg");
	private int width, height;
	private Image versusButton = Toolkit.getDefaultToolkit().getImage("versus.png");
	private Image versusHoverButton = Toolkit.getDefaultToolkit().getImage("versus_hover.png");
	private int versusX = 587, versusY = 220;
	private int versusWidth = 170, versusHeight = 130;
	private Image aboutButton = Toolkit.getDefaultToolkit().getImage("about.png");
	private Image aboutHoverButton = Toolkit.getDefaultToolkit().getImage("about_hover.png");
	private int aboutY = versusY+150;
	private Image quitButton = Toolkit.getDefaultToolkit().getImage("quit.png");
	private Image quitHoverButton = Toolkit.getDefaultToolkit().getImage("quit_hover.png");
	...
	private Image arena1 = Toolkit.getDefaultToolkit().getImage("Arena.gif");
	private Image beachArena = Toolkit.getDefaultToolkit().getImage("b_arena.jpg"); 
	private Image mainMenu = Toolkit.getDefaultToolkit().getImage("mainMenu.png");
	private Image menuButton = Toolkit.getDefaultToolkit().getImage("menu_Button.png");
	private Image menuHoverButton = Toolkit.getDefaultToolkit().getImage("menu_HoverButton.png");
	private Image stageSelection = Toolkit.getDefaultToolkit().getImage("stageSelection.png"); 
